...
use MLocati\Nexi\XPayWeb\Entity\CreateOrderForHostedPayment\Request as NexiOrderRequest;
use MLocati\Nexi\XPayWeb\Entity\CreateOrderForHostedPayment\Response as NexiOrderResponse;
 ...
 *     name="CommunityStoreNexiXPayWebOrders",
 *     options={"comment": "Hosted orders for Nexi XPay Web payment method"}
 * )
 */
class XPayWebOrder
{
    ...
    /**
     * The XPayWebOrder\Check instances associated to this XPayWebOrder.
     *
     * @Doctrine\ORM\Mapping\OneToMany(targetEntity="Concrete\Package\CommunityStoreNexi\Entity\XPayWebOrder\Check", mappedBy="xPayWebOrder")
    ...
    /**
     * Get the XPayWebOrder\Check instances associated to this XPayWebOrder.
     */
